...
<div class="settings-change">
    ...
    float: left;">
                ...
                <br>
								<div class="row np">
                    <div class="col-md-6">
                        <label for="basics_welcome_title">Főcím</label>
                        <input type="text" id="basics_welcome_title" name="welcome_title" class="form-control" value="<?=$this->settings['welcome_title']?>">
                    </div>
										<div class="col-md-6" style="padding-left:8px;">
                        <label for="basics_welcome_subtitle">Alcím</label>
