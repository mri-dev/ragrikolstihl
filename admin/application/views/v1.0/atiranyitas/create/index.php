...
<div class="con">
	<form method="post" action="">
		...
		<em>
			...
			<div><sup>2</sup> Megadhat helyi URL-t és külső hivatkozást is. Külső hivatkozás esetén használjon http:// vagy https:// protokollal kezdődő URL-eket. Pl.: http://www.google.com/, <?=$this->settings['page_url']?></div>
		</em>
	</form>
</div>
