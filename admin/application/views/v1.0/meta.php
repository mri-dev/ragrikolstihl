...
<script defer src="//ajax.googleapis.com/ajax/libs/angular_material/1.1.6/angular-material.min.js"></script>

<?=$this->addJS('app',false,false)?>
<script defer type="text/javascript" src="<?=JS?>tinymce/tinymce.min.js"></script>
