...
class user extends Controller{
		...
		function dokumentumok(){
			...
			$this->out('files', $this->shop->checkDocuments($this->view->user['data'], $files, array('stacked' => true, 'user_group_in' => $this->view->user['data']['user_group'])) );
			$this->out('doc_groupes', $this->shop->getDocumentGroupes());

			$this->shop->setSeenUnwatchedDocuments( $this->view->user['data']['ID'], $this->view->files );
		}
